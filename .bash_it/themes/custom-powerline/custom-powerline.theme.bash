...
. "$BASH_IT/themes/custom-powerline/custom-powerline.base.bash"

PROMPT_CHAR=${POWERLINE_PROMPT_CHAR:=""}
POWERLINE_LEFT_SEPARATOR=${POWERLINE_LEFT_SEPARATOR:=""}

USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:=" "}
USER_INFO_THEME_PROMPT_COLOR=24
...
SCM_THEME_PROMPT_UNSTAGED_COLOR=29
...
POWERLINE_PROMPT=${POWERLINE_PROMPT:="user_info scm clock cwd"}

HISTORY_AUTOSAVE=${HISTORY_AUTOSAVE:-0}

DOTFILE_GIT='https://github.com/wjes/dotfiles.git'
