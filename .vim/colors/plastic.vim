...
call <sid>hi('CursorLine',s:none, s:foreground, 'bold', {})
call <sid>hi('EndOfBuffer', s:whisky, s:none, 'none', {})
call <sid>hi('Conceal', s:blue, s:none, 'none', {})
call <sid>hi('CursorColumn', s:none, s:foreground, 'none', {})
...
call <sid>hi('MatchParen', s:black, s:yellow, 'bold', {})
...
call <sid>hi('Todo', s:white, s:aqua, 'italic', {})
